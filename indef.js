...
// ... ... ... Pendiente hasta aquí!! ... ... ...
			...
			{   //lMULTI.classList.add('cX');//Oculta lMULTI
				...
				switch (gRuta)
				{	case 1://
						iMenu.innerHTML = '<i class="'+kTapa1[2][2]+' cTrin"></i>';
					...
					case 2://AJUSTES información palanca - idioma i1 etc
						iMenu.innerHTML = '<i class="'+kTapa1[50][2]+' cTrin"></i>';
						for (v1 = 1; v1 < (visOK.length - 1); v1++)//SE CORRE UNA COLUMNA A LA DERECHA PARA PODER AGREGAR EL LIMITE SUPERIOR Y SE RESTA 1 POR EL LIMITE INFERIOR
						{	let v4 = visOK[v1];//v4:Número de la casilla que sigue
							//PRECARGA de textos:
					...
					case 3://Anuncios - Información comunitaria
						iMenu.innerHTML = '<i class="'+kTapa1[3][2]+' cTrin"></i>';
					...
					break;
					case 4:
						iMenu.innerHTML = '<i class="'+kTapa1[4][2]+' cTrin"></i>';
						for (v1 = 1; v1 < (visOK.length - 1); v1++)//SE CORRE UNA COLUMNA A LA DERECHA PARA PODER AGREGAR EL LIMITE SUPERIOR Y SE RESTA 1 POR EL LIMITE INFERIOR
						{	let v4 = visOK[v1];//v4:Número de la casilla que sigue
							//PRECARGA de textos:
					...
					break;
					case 7:
						iMenu.innerHTML = '<i class="'+kTapa1[43][2]+' cTrin"></i>';
						for (v1 = 1; v1 < (visOK.length - 1); v1++)//SE CORRE UNA COLUMNA A LA DERECHA PARA PODER AGREGAR EL LIMITE SUPERIOR Y SE RESTA 1 POR EL LIMITE INFERIOR
						{	let v4 = visOK[v1];//v4:Número de la casilla que sigue
					...
					case 8://Ayudas - 
						...
						iMenu.innerHTML = '<i class="'+kTapa1[73][2]+' cTrin"></i>';
						for (v1 = 1; v1 < (visOK.length - 1); v1++)//SE CORRE UNA COLUMNA A LA DERECHA PARA PODER AGREGAR EL LIMITE SUPERIOR Y SE RESTA 1 POR EL LIMITE INFERIOR
						{	let v4 = visOK[v1];//v4:Número de la casilla que sigue
...
f0042=()=>//HACER faro on y VIBRAR
		{	lOL(42);
			...
			{	yHear.style.backgroundColor = 'var(--cblwh1)';//'var(--cblwh1)';
...
f0043=()=>//L HACER faro off y si puede vibrar PARAR cualquier vibración anterior - - - HACER faro off y PARAR vibración
		{	lOL(43);
			...
			{	//iFaro.style.color = 'white!important';//'var(--cblwh2)';	
				yHear.style.backgroundColor = 'var(--cblwh2)';
						...
						{	case 1://AJUSTES 1
							...
							case 4://MENÚ PRINCIPAL	
								...
								//	case 4:hh35(0,rev);break;//2
									...
									case 18:hh71(0,rev);break;
									case 19:hh6(0,rev);break;
									case 20:hh98(0,rev);break;
									case 21:hh99(0,rev);break;//Reiniciar
...
// - - - - - - -
		...
		//++contPre[0] = aPulPre;//Reinicia el conteo de la duración del anuncio
			...
			iMenu.innerHTML = '<i class="'+kTapa1[69][2]+' cTrin"></i>';//<i class="'+kTapa1[16   -   51][2]+' cTrin"></i>';
...
hh72=()=>//COLOREAR borde de la presentación AV, cargar el codigo QR, el logo y la imagen
		{	hOG(72);
			...
			iCodQ.innerHTML = "<img src='"+(kTapa0[bus][2]||'files/qrcode.jpg')+"' class='cBox'>";
			//iCodQ.innerHTML = "<img src='"+(kTapa0[dExt[4]][2]||'files/qrcode.jpg')+"' class='cBox'>";
		}
